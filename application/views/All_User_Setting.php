...
<div class="container">
    <!--<div class="row">
        <div class="col-md-12">
            <br><br>
            <div class="btn-group" data-toggle="buttons" id="seprate_btn">
              <label class="btn btn-default active">
                <input type="radio" name="options" id="option1" autocomplete="off"> 依分組排序
              </label>
              <label class="btn btn-default">
                <input type="radio" name="options" id="option2" autocomplete="off"> 依檔號排序
              </label>
            </div>
            <br><br>
        </div>
...
<!--
    <div class="row">
         <div class="col-md-12"><h1>山線地區</h1></div>
        <div class="col-md-4">
            <div class="thumbnail">
                <h3 style="font-weight: 600;">中區區公所</h3>
                <p>概略申請流程與申辦時之應備文件</p>
                <table class="table table-hover">
                <thead>
                <tr><th>姓名</th><th>職稱</th><th>測試</th></tr>
                </thead>
                <tbody>
                <tr><td>范文芳</td><td>女主一</td><td>測試</td></tr>
                <tr><td>李冰冰</td><td>女配一</td><td>測試</td></tr>
                <tr><td>郭台銘</td><td>男主一</td><td>測試</td></tr>
                </tbody>
                </table>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h3 style="font-weight: 600;">申請流程</h3>
            <p>概略申請流程與申辦時之應備文件</p>
        </div>
        <div class="col-md-4">
            <h3 style="font-weight: 600;">申請流程</h3>
