/*************************函式庫****************************************/    
    ...
    function rf_mem_property(propertys){
        ...
        // $.each(propertys, function(property, val) {
        ...
        //                         '<option value="Deposits" selected="selected">儲蓄存款</option>' +
        //                         '<option value="Securities" '+ property.type=="有價證券" +'>有價證券</option>' +
        ...
        //     <div class="proper-inc-div" code="new" edit="new">
        ...
        //             <option value="others">其他</option>
        //         </select>
        //         <input placeholder="價值" class="people-input-right proper-inc-div-2" value="0">
        //         <input placeholder="地址/地號/銀行/公司" class="people-input-left proper-inc-div-3" value="">
        ...
        //             <option value="y">非自住</option></select>
        ...
        //         <button type="button" class="close" data-toggle="modal" data-target="#confirm-delete-pro" aria-label="Close" style="top: 0.2em;right: 0.2em;position: absolute;"><span aria-hidden="true">×</span></button>
        //             <select class="proper-inc-div-1">
        //             <option value="Deposits">儲蓄存款</option>
        //             <option value="Securities">有價證券</option>
        //             <option value="Investment">投資</option>
        //             <option value="Houses" selected="selected">房屋</option>
        //             <option value="Land">土地</option>
        //             <option value="others">其他</option>
        //         </select>
        //         <input placeholder="價值" class="people-input-right proper-inc-div-2" value="0">
